      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            My <span className="text-brand-blue">Achievements</span>
          </h2>
          <div className="h-1 w-20 bg-brand-orange mx-auto mb-6"></div>
          <p className="max-w-2xl mx-auto text-gray-700">
            Personal records and competitive achievements that demonstrate my
            dedication to fitness and endurance sports.
          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Completed the challenging half Ironman distance triathlon,
                    consisting of a 1.9 km swim, 90 km bike ride, and 21.1 km
                    run.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Finished a full marathon in under 3 hours (2:56:09), an
                    achievement that puts me in the top percentile of marathon
                    runners worldwide.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Achieved numerous top-3 finishes in local and regional
                    running events across various distances.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gray-50 p-8 rounded-xl shadow-sm">
            ...
            <div className="mt-6 p-6 bg-brand-blue bg-opacity-10 rounded-lg border border-brand-blue border-opacity-20">
              <p className="text-gray-700 italic">
                "Every personal best represents countless hours of training,
                discipline, and determination. I bring this same dedication to
                helping my clients achieve their fitness goals."
              </p>
            </div>
          </div>
        </div>
