        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-dark leading-tight">
              {t.hero.title} <span className="text-brand-blue">{t.hero.titleHighlight}</span> {t.hero.title.includes('Transform') ? 'Journey with Edgar Zanin' : 'com Edgar Zanin'}
            </h1>
          ...
          <div className="relative hidden lg:block">
            <div className="bg-gradient-to-b from-white to-gray-50 p-6 rounded-lg shadow-xl max-w-md ml-auto animate-slide-up relative" style={{ animationDelay: '0.4s' }}>
              ...
              <h3 className="text-xl font-bold text-brand-dark mb-4 text-center pt-4">{t.hero.achievementShelf}</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white rounded-lg p-4 shadow-md border-l-4 border-brand-orange flex items-start">
                  ...
                  <div>
                    <h4 className="font-bold text-brand-dark">{t.hero.ironmanTitle}</h4>
                    <p className="text-sm text-gray-600">{t.hero.ironmanDescription}</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="bg-white rounded-lg p-3 shadow-md border-t-2 border-brand-blue">
                    <p className="text-xs text-gray-500 mb-1">{t.hero.records["5k"]}</p>
                    <p className="font-bold text-lg text-brand-blue">19:16</p>
                  </div>
                  <div className="bg-white rounded-lg p-3 shadow-md border-t-2 border-brand-blue">
                    <p className="text-xs text-gray-500 mb-1">{t.hero.records["10k"]}</p>
                    <p className="font-bold text-lg text-brand-blue">36:31</p>
                  </div>
                  <div className="bg-white rounded-lg p-3 shadow-md border-t-2 border-brand-blue">
                    <p className="text-xs text-gray-500 mb-1">{t.hero.records.halfMarathon}</p>
                    <p className="font-bold text-lg text-brand-blue">1:20:00</p>
                  </div>
                  <div className="bg-white rounded-lg p-3 shadow-md border-t-2 border-brand-blue">
                    <p className="text-xs text-gray-500 mb-1">{t.hero.records.marathon}</p>
