    ...
    <section id="services" className="section bg-gray-50">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">{t.services.title} <span className="text-primary">{t.services.titleHighlight}</span></h2>
      ...
      {services.map((service, index) => (
        ...
        <div className="mt-16 rounded-xl shadow-lg overflow-hidden" style={{ background: 'linear-gradient(to right, hsl(var(--primary)), hsl(var(--primary)) 100%)' }}>
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-8 md:p-12 flex flex-col justify-center">
              ...
              <div>
                <a href="#contact" className="inline-block px-6 py-3 bg-white text-primary font-bold rounded-md hover:bg-gray-100 transition-colors">
